...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<VerifyEmail> verificationCode(VerifyRequset request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(request.toJson());
    final _options = _setStreamType<VerifyEmail>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late VerifyEmail _value;
    try {
      _value = VerifyEmail.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<ExamsResponse> getExam(String id) async {
    final _extra = <String, dynamic>{};
